...
const App = () => {
    ...
    const saveEvent = async (e) => {
        ...
        data.event_type = eventForm.event_type || computeEventType({...data}) || 'event';
        try {
    ...
    const saveProperty = async (e) => {
        ...
        // event_type: 手動入力があればそれを使用、なければ登録内容から自動判定
        data.event_type = form.event_type || computeEventType(data) || 'event';
        try {
            let tid = editingId;
