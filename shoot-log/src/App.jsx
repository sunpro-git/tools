...
import { formatDate, formatDateTime, toYMD, formatRepName, formatCurrency, handleShowPicker, DowLabel, computeShootStatus } from './helpers';
...
const App = () => {
    ...
    const [form, setForm] = useState({
        name: '', address: '', category: '新築', subCategory: '', furnitureSetup: 'なし', customerName: '', customerAndpadId: '', customerLat: '', customerLon: '', mainStore: '',
    ...
    const openEditModal = (prop) => {
        ...
        setForm({
            ...prop, category: cat,
            customerName: prop.customerName||'', customerAndpadId: prop.customerAndpadId||'', customerLat: prop.customerLat||'', customerLon: prop.customerLon||'', mainStore: prop.mainStore||'', googleMapUrl: prop.googleMapUrl||'', handoverSource: prop.handoverSource||'', furnitureSetup: prop.furnitureSetup||'なし',
    ...
    const saveProperty = async (e) => {
        ...
        try {
            ...
            setIsModalOpen(false); showNotification('保存完了'); autoSyncCalendar({...data, id: tid, event_type: oldProp?.event_type || 'その他'}, oldProp); sendChatworkNotification({...data, id: tid}, isNew);
